...
REM
REM  El tunel apunta al 9600, donde el backend sirve el API y tambien el
...
curl -s -o nul -m 5 http://127.0.0.1:9600/
if errorlevel 1 (
    echo  [X] El backend no responde en el puerto 9600.
    echo.
...
echo  [OK] Backend respondiendo en el 9600.
echo.
